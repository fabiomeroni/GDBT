...
const DICTIONARY = [
  {
    ...
    gloss: "proximal demonstrative determiner — this, these",
    glossRich: "proximal demonstrative determiner — <em>this, these</em>",
...
// ── Helper: stable slug for deep-linking texts ────────────────
...
// ── Grammar sections ──────────────────────────────────────────
// Every .example div carries:
//   data-text-lang="…"   data-text-title="…"
// These are resolved at runtime (grammar.html) to the Pangloss URL
// + a texts.html deep-link anchor.
//
// Every <a class="lexlink" href="dictionary.html#ID"> is enhanced
// at runtime with a floating tooltip showing the dictionary gloss.
const GRAMMAR = [
  {
...
<strong>Lakon</strong>, distributed from east to west across the island. All five are closely related Oceanic
languages of the Austronesian family. They share a common proto-language and form a coherent dialect chain —
yet they are not mutually intelligible, and each has developed distinct phonological, morphological, and
syntactic properties.</p>
<p>All grammatical claims are illustrated by interlinear glossed text examples drawn from the archived corpora.
<strong>Hover over any word</strong> in a glossed example to see its dictionary definition;
<strong>click it</strong> to open its full entry in the <a href="dictionary.html">Dictionary</a>.
Each example also links back to the source text in the <a href="texts.html">Texts</a> archive.</p>
<p>Glossing abbreviations follow the Leipzig Glossing Rules. Coloured labels identify the language of each
example: <span class="chip" style="background:#2e5c8a">Nume</span>&thinsp;<span class="chip" style="background:#c07820">Dorig</span>&thinsp;<span class="chip" style="background:#922810">Koro</span>&thinsp;<span class="chip" style="background:#267040">Olrat</span>&thinsp;<span class="chip" style="background:#5c2878">Lakon</span>.</p>`
  },
  {
...
<p>The five languages of Gaua share a common phonological inventory inherited from Proto-Oceanic, though each
has developed distinct local innovations. All five possess a series of prenasalised stops (<em>mb, nd, ngg</em>),
contrasting with plain stops (<em>p, t, k</em>). The consonantal inventories are summarised in Table 1.</p>
...
Koro <a class="lexlink" href="dictionary.html#gor"><em>gōr</em></a> 'man' (long <em>ō</em>)
vs. <em>gor</em> 'to call' (short <em>o</em>). The languages also exhibit a uvular stop /q/ and a
mid-back rounded vowel /ō/ — both rare in the wider Oceanic family yet consistent across the entire
Gaua dialect chain.</p>

<h3 id="s2-3">2.3 Prenasalised stops <a href="#top" class="totop">↑</a></h3>
<p>A notable areal feature is the retention of Proto-Oceanic *R as a uvular trill in Koro and Lakon, which has
merged with /r/ in Nume, Dorig, and Olrat. Stress is generally penultimate but shifts to the final syllable in
verb stems followed by the completive aspect marker
<a class="lexlink" href="dictionary.html#qet"><em>qēt</em></a>.</p>

<div class="example" id="ex1"
     data-text-lang="Koro" data-text-title="The origin of the coconut">
...
Subject pronouns function as proclitics attaching to the left edge of the verb, separated by the phonological
boundary marker <strong>=</strong>.</p>

<h3 id="s3-1">3.1 Singular forms <a href="#top" class="totop">↑</a></h3>
<p>Remarkably, the singular forms are near-identical across all five languages, attesting to the conservative
nature of this paradigm within the Gaua dialect chain. Divergence emerges in the dual and plural, where Lakon
shows the most pronounced differences from the eastern varieties.</p>
...
<div class="example" id="ex2"
     data-text-lang="Koro" data-text-title="Kava ceremonies">
...
<div class="example" id="ex3"
     data-text-lang="Lakon" data-text-title="A day of fishing">
...
<p>The dual, paucal, and plural series each require a separate proclitic paradigm. In all five languages, the
1st person non-singular distinguishes an <em>inclusive</em> form (speaker + addressee + others) from an
<em>exclusive</em> form (speaker + others, addressee excluded). This four-way number distinction combined with
clusivity gives the Gaua languages a pronominal system of considerable typological
complexity.<sup><a href="#fn1">1</a></sup></p>`
  },
  {
    ...
    body:`<p>Verbs in the Gaua languages are morphologically conservative: they do not inflect for tense, aspect,
or mood through affixation. Instead, temporal and aspectual meaning is expressed through post-verbal particles.
The subject proclitic agrees with the grammatical subject.</p>
...
found in identical form across all five languages. This particle follows the verb and signals that an action
has been completed. It is one of the most remarkable isoglosses in the Gaua dialect chain.</p>

<div class="example" id="ex4"
     data-text-lang="Nume" data-text-title="The orphan and the chief">
...
<div class="example" id="ex5"
     data-text-lang="Dorig" data-text-title="Qat and his brothers">
...
<p>Verbs are broadly divided into transitive and intransitive. Transitive verbs
(<a class="lexlink" href="dictionary.html#kan"><em>kan</em></a> 'eat',
...
<a class="lexlink" href="dictionary.html#wer"><em>wer</em></a> 'be big') do not. Stative verbs form a
sub-class of intransitives: they function as predicate adjectives when the subject proclitic is prefixed
directly to the property concept root.</p>`
  },
  {
    ...
    body:`<p>Possession in the Gaua languages is encoded through a system of possessive classifiers — a
well-known feature of Oceanic languages. Nouns are classified semantically according to the type of
relationship they hold with their possessor.</p>

<h3 id="s5-1">5.1 Classifier classes <a href="#top" class="totop">↑</a></h3>
<p>Two main possession types are distinguished: <em>direct possession</em> (inalienable: body parts, kinship
terms) and <em>indirect possession</em> (mediated by a classifier). The three main classifier classes are:</p>
<table class="gram-table">
...
<p>This tripartite distinction is preserved intact across all five languages, constituting one of the strongest
shared structural features of the Gaua dialect chain.</p>

<div class="example" id="ex6"
     data-text-lang="Koro" data-text-title="The jealous brother">
  ...
  },
  {
    ...
    body:`<p>Verbal negation in the Gaua languages follows a consistent pattern using the pre-verbal particle
...
<p>In some registers and languages, a post-verbal negation suffix <em>-(V)t</em> co-occurs with <em>tō</em>,
creating a discontinuous negation pattern parallel to the Jespersen cycle found in French (<em>ne … pas</em>)
and many other languages. In casual speech, the post-verbal element is frequently dropped, especially in Lakon
and Olrat.</p>

<div class="example" id="ex7"
     data-text-lang="Koro" data-text-title="Preparing a garden">
...
<div class="example" id="ex8"
     data-text-lang="Lakon" data-text-title="Origin of the Lakon dances">
